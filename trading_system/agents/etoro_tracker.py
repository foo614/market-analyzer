...
from config import (
    ...
    TRACKER_POLL_INTERVAL, system_path
)
...
def generate_performance_report(conn, is_real=False):
    ...
    report_content = "\n".join(report_lines)
    report_path = system_path("etoro_performance.md")
    ...
    def start(self):
        ...
        while self.running:
            try:
                ...
                conn_demo = init_db(system_path("etoro_trades_demo.db"))
                ...
                conn_real = init_db(system_path("etoro_trades_real.db"))
